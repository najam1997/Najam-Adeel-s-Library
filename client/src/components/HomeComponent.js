...
render(){
    return(
        ...
        <br/><br/><br/>
            <h6>
            This Library is the heart of Pakistan providing direct academic and research supports to all students of Knowledge.

            This Library is an automated library in terms of records organisation and management of all its different sections, search and discovery, information retrieval and service delivery.
            <br/><br/> </h6>
            </div>
