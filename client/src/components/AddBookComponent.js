 ...
 return (
  ...
  <h3 align="center">  Add a book</h3>
    ...
    <LocalForm onSubmit={(values) => {
        this.props.postBook(values.name, values.author, values.description, values.isbn, values.cat, values.subcat, values.floor, values.shelf, values.copies);
    }}>
                    <Row className="form-group">
                        ...
                        <Row className="form-group">
                            ...
                            <Control.select defaultValue="Romance" model=".subcat" id="subcat" className="form-control">
