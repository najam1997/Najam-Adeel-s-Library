...
const mapDispatchToProps = dispatch => ({
  ...
  postBook: (name, author, description, isbn, cat, subcat, floor, shelf, copies) => dispatch(postBook(name, author, description, isbn, cat, subcat, floor, shelf, copies)),
  editBook: (_id, name, author, description, isbn, cat, subcat, floor, shelf, copies) => dispatch(editBook(_id, name, author, description, isbn, cat, subcat, floor, shelf, copies)),
    ...
    constructor(props){
      ...
      handleSubmitEdit(values) {
        ...
        this.props.editBook(this.state.selectedBook._id, values.name, values.author,
          values.description, values.isbn, values.cat, values.subcat, values.floor, values.shelf, values.copies);     
        }
                 ...
                 <Modal isOpen={this.state.isEditModalOpen} toggle={this.toggleEditModal}>
                    ...
                    <Row className="form-group">
                        ...
                        <Row className="form-group">
                            ...
                            <Control.select model=".subcat" id="subcat" className="form-control" defaultValue={this.state.selectedBook.subcat}>
