...
export const postBook = (name, author, description, isbn, cat, subcat, floor, shelf, copies) => (dispatch) => {
    const newBook = {
      name: name, author: author,
       description: description, isbn: isbn,
        cat: cat, subcat: subcat, floor: floor, 
...
export const editBook = (_id, name, author, description, isbn, cat, subcat, floor, shelf, copies) => (dispatch) => {
